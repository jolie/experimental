 ...
 * <ul>
 *   <li>{@link jolie.xtext.jolie.Define#getName <em>Name</em>}</li>
 *   <li>{@link jolie.xtext.jolie.Define#getMainrocess <em>Mainrocess</em>}</li>
 * </ul>
 * </p>
 *
 * @see jolie.xtext.jolie.JoliePackage#getDefine()
 * @model
 * @generated
 */
public interface Define extends EObject
{
   ...
   * @see #setName(String)
   * @see jolie.xtext.jolie.JoliePackage#getDefine_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link jolie.xtext.jolie.Define#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see jolie.xtext.jolie.JoliePackage#getDefine_Mainrocess()
  ...
  /**
   * Sets the value of the '{@link jolie.xtext.jolie.Define#getMainrocess <em>Mainrocess</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
