 ...
 * <ul>
 *   <li>{@link jolie.xtext.jolie.PostIncrementStatement#getPostIncrementStatement <em>Post Increment Statement</em>}</li>
 *   <li>{@link jolie.xtext.jolie.PostIncrementStatement#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see jolie.xtext.jolie.JoliePackage#getPostIncrementStatement()
 * @model
 * @generated
 */
public interface PostIncrementStatement extends BasicStatement
{
   ...
   * @see jolie.xtext.jolie.JoliePackage#getPostIncrementStatement_PostIncrementStatement()
  ...
  /**
   * Sets the value of the '{@link jolie.xtext.jolie.PostIncrementStatement#getPostIncrementStatement <em>Post Increment Statement</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setName(String)
   * @see jolie.xtext.jolie.JoliePackage#getPostIncrementStatement_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link jolie.xtext.jolie.PostIncrementStatement#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
