 ...
 * <ul>
 *   <li>{@link jolie.xtext.jolie.impl.IncludeImpl#getPath <em>Path</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IncludeImpl extends MinimalEObjectImpl.Container implements Include
{
  ...
  {
    return JoliePackage.Literals.INCLUDE;
  }
  ...
  public EList<String> getPath()
  {
    if (path == null)
    {
      path = new EDataTypeEList<String>(String.class, this, JoliePackage.INCLUDE__PATH);
    }
    return path;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case JoliePackage.INCLUDE__PATH:
        return getPath();
    }
